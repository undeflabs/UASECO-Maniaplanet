You can freely modify these files but please read the following:
 ...
 - Do NOT change the text IDs! Otherwise your translation does not apply!
...
If you're a plugin developer:
 - First of all: even if you do not plan to translate your plugin: use this feature and just add one language to the xml.
